...
AS
BEGIN
SELECT USU_FECHA_REG FECHA, USU_NOMBRE +' '+ USU_APE_PAT +' '+ USU_APA_MAT NOMBRE, USU_CORREO CORREO
FROM USUARIO
WHERE USU_ROL != 1
END
GO

INSERT INTO USUARIO VALUES(1,'', 'DIEGO', 'MENDOZA', 'REYES', 1, 20,'LA CALLE', '3464554','D@MAIL.COM','DIG','DIG',1,GETDATE())
GO

INSERT INTO USUARIO VALUES(2,'', 'GEOVANA', 'GÓMEZ', 'CRUZ', 2, 21,'LA AVENIDA', '123456413','G@MAIL.COM','GEO','GEO',1,GETDATE())
GO

INSERT INTO USUARIO VALUES(3,'', 'ADALEYSI', 'LARA', 'FELICIANO', 2, 22,'LA CERRADA', '2334132','A@MAIL.COM','ADA','ADA',1,GETDATE())
GO
